        ...
        <div class="col-xs-12">
            <div class="box box-primary">
                ...
                <div class="box-footer">
                    <h4>QA:</h4>
                    <span>1.獎金發放作業 在每月5號以前發放皆為當月,6號開始發放將為次月 <strong style='color:blue;'>例： 1.6號 發放獎金 獎金發放檢視 查詢該筆資料 將會在2月, 1.5號 發放獎金 獎金發放檢視 查詢該筆資料 將會在1月</strong></span></br>
            ...
            <div class="box box-primary">
                ...
                <div class="box-footer">
                    <h4>QA:</h4>
                    <span>1.每日連動後台 更新財報資料(&收款資料) 時間為00:00、12:00、18:00,任何在後台輸入的財報資料需等待更新後才會出現在業績系統</span></br>
                </div>
            </div>
        </div>
        <!-- /.col -->
