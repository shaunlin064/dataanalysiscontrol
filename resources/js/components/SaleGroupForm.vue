						...
						<div class="box-body">
							<table class="table table-bordered table-striped">
								...
								<tr v-for="(item, index) in items" :key="index">
									...
									<td :class="{'has-error' : detail_has_error[index]['achieving_rate']}">
										...
										<input type='number' class="form-control form-control-sm" v-model="item.achieving_rate" v-else-if="editIndex === index">
				            ...
				            <span v-if="editIndex !== index">
						            <div v-for='(item, index ) in items'>
						              <input type='hidden' :name='"groupsBonus["+index+"][achieving_rate]"' :value='item.achieving_rate'>
