    ...
    Route::group([ 'middleware' => [ 'auth', 'GetMenuList' ] ], function () {
        ...
        Route::group([ 'namespace' => '\App\Http\Controllers' ], function () {
            Route::prefix('financial')->group(function () {
                Route::group([ 'namespace' => '\App\Http\Controllers\Financial' ], function () {
                    /*匯率設定*/
                    Route::get('/exchangeRateSetting', 'ExchangeRatesController@setting')
                         ->name('financial.exchangeRate.setting');
                    Route::get('/exchangeRateSetting/view', 'ExchangeRatesController@view')
                         ->name('financial.exchangeRate.view');
                    Route::post('/add', 'ExchangeRatesController@add')->name('financial.exchangeRate.add');
                    Route::any('/exchangeRateSetting/getAjaxData', 'ExchangeRatesController@getAjaxData')
                         ->name('financial.exchangeRate.getAjaxData');
                    /*獎金發放*/
                    Route::prefix('/provide')->group(function () {
                        ...
                        Route::any('/getAllSelectId', 'ProvideController@getAllSelectId')
                             ->name('financial.provide.getAllSelectId');
                        Route::any('/getAjaxData', 'ProvideController@getAjaxData')
                             ->name('financial.provide.getAjaxData');
                        Route::any('/ajaxCalculatFinancialBonus', 'ProvideController@ajaxCalculatFinancialBonus')
                             ->name('financial.provide.ajaxCalculatFinancialBonus');
        ...
        Route::group([ 'namespace' => '\App\Http\Controllers\System' ], function () {
            Route::prefix('system')->group(function () {
                ...
                Route::post('/permissionAddAjaxPost', 'PermissionController@permissionAddAjaxPost')
                     ->name('system.permission.add.ajaxPost');
                Route::post('/permissionEditAjaxPost/{permission}', 'PermissionController@permissionEditAjaxPost')
                     ->name('system.permission.edit.ajaxPost');
                Route::post('/permissionDeleteAjaxPost/{permission}', 'PermissionController@permissionDeleteAjaxPost')
                     ->name('system.permission.ajaxPost');

                Route::post('/permissionClassAddAjaxPost', 'PermissionController@permissionClassAddAjaxPost')
                     ->name('system.permission.class.add.ajaxPost');
                Route::any('/permissionClassDeleteAjaxPost/{permissionsClass}',
                    'PermissionController@permissionClassDeleteAjaxPost')
                     ->name('system.permission.class.delete.ajaxPost');
                Route::any('/permissionClassEditAjaxPost/{permissionsClass}',
                    'PermissionController@permissionClassEditAjaxPost')->name('system.permission.class.edit.ajaxPost');
